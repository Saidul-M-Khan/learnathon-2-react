...
import reader from '../../assets/reader'
      ...
      <div className="my-container flex flex-col items-center justify-between lg:flex-row">
        ...
        <div className="mb-10 lg:max-w-lg  lg:pr-5 lg:mb-0">
          <div className="max-w-xl mb-6 lg:mt-8">
            ...
            <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none uppercase">
              Today a reader,<br className="hidden md:block" /> {" "}
              <span className="inline-block text-blue-400">tomorrow a leader.</span>
            </h2>
